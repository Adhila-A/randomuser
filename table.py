...
def check():
    ...
    return render_template('table.html',ID=ID, NAME=fullname, EMAIL=emailid, 
    PHONENUMBER=random_number ,PROFESSION=Prof,
    SALARY=salary,DATE_OF_JOINING=random_date,YEAR_OF_EXPERIENCE=experience)
